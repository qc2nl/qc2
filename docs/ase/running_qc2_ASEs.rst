...
.. note::
    ...
    naturally abstracted within :class:`~qc2.qc2_driver.QC2`; see :ref:`qc2data_section`.
...
.. note::
    ...
    with :class:`~qc2.qc2_driver.QC2` and, subsequently, with quantum computing libraries.
