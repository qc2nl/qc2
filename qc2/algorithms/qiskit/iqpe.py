...
class IQPE(BaseAlgorithm):
    def __init__(self, 
        ...
        # number of qubits for the precision
    ...
    def run(self) -> QPEResults: 
        ...
        **Example**
        ...
        solver = IterativePhaseEstimation(self.num_iterations, self.sampler)

        # run QPE algorithm  
        qiskit_res = solver.estimate(unitary, self.reference_state)
