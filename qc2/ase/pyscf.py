...
class PySCF(Calculator):
    ...
    def dump_mol_data(self) -> Dict[str, Any]:
        ...
        Notes:
            This method retrieves various molecular data from the PySCF object and saves
            it in a dictionary format. The dictionary includes the molecular charge,
    ...
    def dump_basis_set_data(self) -> Dict[str, Any]:
        ...
        Notes:
            This method retrieves the basis set data from the PySCF object and saves
